...
export default function Home() {
  function handleCTAClick() {
    analytics.trackCustom('lp1-clicked-cta-whatsapp');
    redirect('https://wa.me/5531971689316?text=Ol%C3%A1%2C%20gostaria%20de%20renovar%20minha%20receita%20m%C3%A9dica', true);
  }
      ...
      <section className="hero-bg pt-20 pb-16" role="banner" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <button onClick={handleCTAClick} className="cursor-pointer bg-blue-600 text-white px-8 py-4 text-lg font-semibold rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 shadow-lg focus-visible" aria-label="Renovar receita médica agora">
